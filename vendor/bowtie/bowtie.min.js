...
var page=window.page={url:null,template:null,renderTarget:null,data:null,previewScrollX:null,previewScrollY:null,render:function(e){page.data=e||{};var l=$(document.createElement("div"));$(l).html(page.template(e)),page.renderTarget.replaceWith(l),page.renderTarget=l,$(document).trigger("bowtie:splash-rendered")}};$(function(){var e=$("script#main[type='text/handlebars']");e.length>0&&(page.renderTarget=e,page.template=Handlebars.compile(e.html()),page.render(page.data,!1),null!==page.previewScrollX&&null!==page.previewScrollY&&window.scrollTo(page.previewScrollX,page.previewScrollY))}),window.addEventListener("data",function(e){var l=document.documentElement||document.body.parentNode||document.body;page.previewScrollX=void 0!==window.pageXOffset?window.pageXOffset:l.scrollLeft,page.previewScrollY=void 0!==window.pageYOffset?window.pageYOffset:l.scrollTop,page.render(e.detail)});